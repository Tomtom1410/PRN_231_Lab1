...
namespace ProductManagementClient.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            url = "https://localhost:7168/api/Product/List";
        ...
        {
            url = "https://localhost:7168/api/Product/Categories";
        ...
        public async Task<IActionResult> CreateAsync([FromForm] ProductDto model)
        {
            ...
            url = "https://localhost:7168/api/Product/Create";
        ...
        public async Task<IActionResult> DeleteAsync(int? id)
        {
            ...
            url = $"https://localhost:7168/api/Product/Delete/{id}";
        ...
        public async Task<IActionResult> UpdateAsync([FromForm] ProductDto model)
        {
            ...
            url = "https://localhost:7168/api/Product/Update";
        ...
        private async Task<ProductDto?> GetByIdAsync(int? id)
        {
            ...
            url = $"https://localhost:7168/api/Product/{id}";
            HttpResponseMessage response = await _client.GetAsync(url);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
